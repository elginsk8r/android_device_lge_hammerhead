 ...
 * Poritions Copyright (C) 2014 The Evervolv Project
 *
...
public class VibratorTuningPreference extends DialogPreference implements SeekBar.OnSeekBarChangeListener {
    ...
    public static final String FILE_PATH         = "/sys/class/timed_output/vibrator/amp";
    public static final int MAX_VALUE            = 100;
    public static final int WARNING_THRESHOLD    = -1;
    public static final int DEFAULT_VALUE        = 63;
